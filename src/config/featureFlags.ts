...
export const FEATURE_FLAG_REGISTRY: FeatureFlagDefinition[] = [
  ...
  {
    flag_key: 'pyq_explorer',
    label: 'PYQ Explorer',
    description: 'Previous year question explorer and related surfaces.',
    is_enabled: true,
    rollout_percentage: 100,
    category: 'content',
  },
  {
    flag_key: 'diagnostic_quiz',
    label: 'Diagnostic Quiz',
    description: 'Onboarding diagnostic quiz to assess starting level.',
    is_enabled: true,
    rollout_percentage: 100,
    category: 'core',
  },
  {
    flag_key: 'wrapped_recap',
    label: 'Wrapped Recap',
    description: 'Year-in-review wrapped recap experience.',
    is_enabled: true,
    rollout_percentage: 100,
    category: 'engagement',
  },
  ...
  {
    flag_key: 'pro_plus_library',
    label: 'Pro+ Library',
    description: 'Premium content library for Pro+ subscribers.',
    is_enabled: true,
    rollout_percentage: 100,
    category: 'content',
  },
  {
    flag_key: 'voice_input',
    label: 'Voice Input',
    description: 'Voice-to-text input for AI doubt solver.',
    is_enabled: true,
    rollout_percentage: 100,
    category: 'ai',
  },
  {
    ...
    label: 'Virtual Lab',
    description: 'Interactive virtual lab simulations.',
    is_enabled: true,
    rollout_percentage: 100,
    category: 'content',
  },
  {
    flag_key: 'topic_mastery',
    label: 'Topic Mastery',
    description: 'Per-topic mastery tracking and insights.',
    is_enabled: true,
    rollout_percentage: 100,
    category: 'core',
  },
